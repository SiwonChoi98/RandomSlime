...
//                count = 1;
    ...
    public TweenLerp<string> CreateTween(string end)
    {
        return new TweenLerp<string>(string.Empty, end, SimpleTweener.StringLerp, this);
    }
    ...
    public static string StringLerp(string start, string end, float t)
    {
        if (string.IsNullOrEmpty(end))
            return string.Empty;
        
        int index = Convert.ToInt32((float)end.Length * t);
